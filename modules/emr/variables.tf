...
variable "cidr_egress" {
  description = "egress cidr block for emr master and slave nodes"
}

variable "data_processing_key_arn" {
  description = "Key to encrypt the EMR data"
}
...
/* emr resource label */
variable "generate_emr_label" {
  type    = string
  default = "%s" #companyname-bucketkey-awsregion-awsaccountid-env
}
...
variable "ec2_service_identifier" {
  type        = string
  default     = "ec2.amazonaws.com"
  description = "ec2 service identifier for policy attachment, changes for china"
}

variable "emr_service_identifier" {
  type        = string
  default     = "elasticmapreduce.amazonaws.com"
  description = "emr service identifier for policy attachment, changes for china"
}

variable "appautoscaling_service_identifier" {
  type        = string
  default     = "application-autoscaling.amazonaws.com"
  description = "application autoscaler identifier for policy attachment, changes for china"
}